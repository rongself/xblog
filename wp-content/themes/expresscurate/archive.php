  ...
  <div class="contentWrapper">
    <div class="headerTextBg">
      ...
      <header class="floatLeft headerText">
        <h1 class="page-title" id="site-title">
          <?php
          if (is_day()) {
            printf(__('Daily Archives: %s', 'expresscurate'), get_the_date());
          } elseif (is_month()) {
            printf(__('Monthly Archives: %s', 'expresscurate'), get_the_date(_x('F Y', 'monthly archives date format', 'expresscurate')));
          } elseif (is_year()) {
            printf(__('Yearly Archives: %s', 'expresscurate'), get_the_date(_x('Y', 'yearly archives date format', 'expresscurate')));
          } else {
            if (is_tag()) {
              printf(__('Tag: %s', 'expresscurate'), single_tag_title('', false));
            } else {
              _e('Archives', 'expresscurate');
            }
          };
          ?>
        </h1>
